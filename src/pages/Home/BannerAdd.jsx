...
import image from "../../assets/banner/sunglassadd.png";
...
const BannerAdd = () => {
    ...
    return (
        <div className='my-10 md:my-20'>
             <div className="flex flex-col-reverse md:flex-row text-white px-5 lg:px-0 lg:justify-around items-center w-full bg-black py-10 md:h-[500px]">
                <div className='space-y-6 md:space-y-10 text-center md:text-left'>
                    <h1 className='text-lg md:text-2xl lg:text-4xl font-medium leading-7 md:leading-9'>
                        Enhance your <br /> <span className='pt-2 block'>Real Life Experience</span> 
                    </h1>
                    
                    <Countdown className="text-xl" date={Date.now() + 458895000} renderer={renderer} />

                    <div className="flex justify-center md:justify-start">
                        <Link to="/allproduct/productdetail/66f2756b84fe8b2e3e75c6cd" className='btn btn-success bg-green-400 rounded-sm px-6 md:px-8 text-white'>
                            Buy Now
                        </Link>
                    </div>
                </div>
